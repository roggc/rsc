...
1. Type **_cd name_of_your_project_** and **_npm i_** in your terminal (this installs the dependencies and creates the `node_modules` folder)
1. Then type **_npm run dev_** (this runs rollup in watch mode and creates the `dist` and `public` folders)
1. In a new terminal window, type **_npm start_** (this will start the server)
1. enter **_localhost:8080_** in the browser.
